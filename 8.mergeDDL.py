...
def mergeDDL3(head):
    ...
    while currentNode:
        if not currentNode.child:
            ...
            currentNodeChild = currentNode.child
            while currentNodeChild.next:
                currentNodeChild = currentNodeChild.next
                
            currentNodeChild.next = currentNode.next
            
            if currentNodeChild.next:
                currentNodeChild.next.prev = currentNodeChild
